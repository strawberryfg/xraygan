...
2. Show test accuracy while training to guide the learning of GAN. Changed adversarial weight to *0.25*. **Incldued batch-wise Inception Score as part of loss.**
