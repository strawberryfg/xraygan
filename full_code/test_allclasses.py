...
#6. Training loop
def test(total_trained_samples):
  #netD.train()
  #netG.train()
  total_train = 0
  correct_train = 0
...
start_epoch = 0
if resume_training:
	start_epoch, total_trained_samples = load_model('../models_apr28/ecgan-chest-xray14epo_100.pth')

for epoch in range(101, 107):
    model_name = "../models_allclasses/ecgan-chest-xray14epo_" + str(epoch) + ".pth"    
    start_epoch, total_trained_samples = load_model(model_name)

    #load_gan_and_vanilla('../models_apr28/ecgan-chest-xray14epo_98.pth', '../models_vanilla/ecgan-chest-xray14epo_101.pth')
    test(total_trained_samples)
    print("Testing Epoch {:5d} Done\n".format(epoch))
