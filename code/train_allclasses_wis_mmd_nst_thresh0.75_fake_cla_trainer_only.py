...
weights_prefix = '../models_allclasses_wis_mmd_nst_0.75_fake_cla_only/'
weights_middle_name = "_allclasses_is_mmd_nst_thresh0.75_fake_cla_only_epo_"
#0. torch imports
import torch
...
def train(total_trained_samples):
  ...
  for epoch in range(start_epoch, epochs):
    ...
    for steps in range(epoch_imgs // batch_size):
        ...
        realClassifierLoss = criterion(predictions, labels) * 0.0 #alpha_c
        # Do not backprop on real samples
