...
def train(total_trained_samples):
  ...
  for epoch in range(start_epoch, epochs):
    ...
    model_file = '../models_allclasses/' + model_ckpt_prefix + '_th0.8_epo_' + str(epoch + 1) + '.pth'
    torch.save(state, model_file)
...
if resume_training:
    ...
    #load_model('../models_allclasses/ecgan-chest-xray14_th0.8_epo_100.pth')
