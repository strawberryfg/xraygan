...
weights_middle_name = "_allclasses_is_mmd_nst_thresh0.8_may6_realall_epo_"
#0. torch imports
import torch
...
# May 6: extend to all classes starting from 133
...
start_epoch = 0
if resume_training:
	start_epoch, total_trained_samples = load_model('../models_allclasses_wis_mmd_nst/ecgan-chest-xray14_allclasses_is_mmd_epo_133.pth')
